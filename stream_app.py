	...
	with st.empty():
		try:
			...
			with st.container():
				...
				st.write(e)
				st.write("Please use the scraper and parser and make sure the data is accessible via './data/file.csv' before running the app.")
...
with st.sidebar:
	st.sidebar.title("Search Dataset")
